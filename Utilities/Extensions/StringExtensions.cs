...
public static class StringExtensions
{
    ...
    public static string ReplaceOtherThan(this string text, HashSet<char> allowedChars, char charToReplace)
    {
        ...
        if (allowedChars is null) throw new ArgumentNullException(nameof(allowedChars));
        ...
        for (var i = 0; i < chars.Length; ++i)
        {
            ...
            if (!allowedChars.Contains(currentChar)) chars[i] = charToReplace;
        }
    ...
    public static string ReduceLength(this string text, int maxLength)
    {
        ...
        if (maxLength < 3) throw new ArgumentOutOfRangeException(nameof(maxLength));
